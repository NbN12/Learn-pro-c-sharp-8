...
{
    using PeopleStack = Stack<Person>;
    class Program
    {
        ...
        private static void UseDictionary()
        {
            ...
            peopleDict.Add("Homer", new Person { FirstName = "Homer", LastName = "Simpson", Age = 47 });
            peopleDict.Add("Marge", new Person
            {
                FirstName = "Marge",
                LastName = "Simpson",
                Age = 45
            });
            peopleDict.Add("Lisa", new Person { FirstName = "Lisa", LastName = "Simpson", Age = 9 });

            // Get Homer.
            Person homer = peopleDict["Homer"];
        ...
        {
            PeopleStack stackOfPeople = new PeopleStack();
