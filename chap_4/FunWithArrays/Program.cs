...
namespace FunWithArrays
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SystemArrayFunctionalityCSharp8();
            Console.ReadLine();
        }

        static void SystemArrayFunctionalityCSharp8()
        {
            Console.WriteLine("=> Arrays as params and return values. (C#8 style)");
            ...
            Console.WriteLine();
            ////////////////////////////////////////////////
            /// the last item in a sequence is one less than the actual length, so ^0 would
            ...
            Index idx1 = 0;
            Index idx2 = 2;
            Range range = idx1..idx2; //the end of the range is exclusive
