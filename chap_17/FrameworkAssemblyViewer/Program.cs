...
namespace FrameworkAssemblyViewer
{
    class Program
    {
        private static void DisplayInfo(Assembly a)
        {
            ...
            var publicEnums = types.Where(pe => pe.IsEnum && pe.IsPublic);
        ...
        static void Main(string[] args)
        {
            ...
            var displayName = "Microsoft.EntityFrameworkCore, Version=3.1.3.0, Culture=\"\", PublicKeyToken=adb9793829ddae60";
